...
data <- read.csv('./data/dataSS.csv',row.names=1,header=T)
...
ngroupsbar <- data.frame(participant = c("P1","P2","P3","P4","P5","P6","P7"),ngroups = ngroups)

pdf("./plots/SS/ngroups.pdf",width = 10,height = 10)
print(
ggplot(ngroupsbar,aes(x=participant,ngroups)) + geom_bar(stat="identity") + labs(y="Number of groups",x="Participant") +theme_bw()
)
dev.off()

pdf("./plots/SS/dendro_2groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=2,border="red")
dev.off()

pdf("./plots/SS/dendro_3groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=3,border="red")
dev.off()

pdf("./plots/SS/dendro_4groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=4,border="red")
dev.off()

pdf("./plots/SS/dendro_5groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=5,border="red")
dev.off()

pdf("./plots/SS/dendro_6groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=6,border="red")
dev.off()

pdf("./plots/SS/dendro_7groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=7,border="red")
dev.off()

pdf("./plots/SS/dendro_8groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA)
rect.hclust(clust,k=8,border="red")
dev.off()

pdf("./plots/SS/dendro_9groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=9,border="red")
dev.off()

pdf("./plots/SS/dendro_10groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=10,border="red")
dev.off()

pdf("./plots/SS/dendro_11groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
...
pdf("./plots/SS/mdsdim1dim2text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/SS/mdsdim1dim3.pdf",width = 10,height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/SS/mdsdim1dim3text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/SS/mdsdim1dim4text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/SS/mdsdim2dim3text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/SS/mdsdim3dim4text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
