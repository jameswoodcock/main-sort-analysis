...
data <- read.csv('./data/dataFF.csv',row.names=1,header=T)
...
pdf("./plots/FF/ngroups.pdf",width = 10,height = 10)
print(
ggplot(ngroupsbar,aes(x=participant,ngroups)) + geom_bar(stat="identity") + labs(y="Number of groups",x="Participant") +theme_bw()
)
dev.off()

pdf("./plots/FF/dendro_2groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=2,border="red")
dev.off()

pdf("./plots/FF/dendro_3groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=3,border="red")
dev.off()

pdf("./plots/FF/dendro_4groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=4,border="red")
dev.off()

pdf("./plots/FF/dendro_5groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=5,border="red")
dev.off()

pdf("./plots/FF/dendro_6groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=6,border="red")
dev.off()

pdf("./plots/FF/dendro_7groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=7,border="red")
dev.off()

pdf("./plots/FF/dendro_8groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA)
rect.hclust(clust,k=8,border="red")
dev.off()

pdf("./plots/FF/dendro_9groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=9,border="red")
dev.off()

pdf("./plots/FF/dendro_10groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
rect.hclust(clust,k=10,border="red")
dev.off()

pdf("./plots/FF/dendro_11groups.pdf",width = 11, height = 8)
#plot(clust,hang=-1)
plot(clust, xlab=NA, sub=NA, main=NA, cex = 0.5)
...
pdf("./plots/FF/mdsdim1dim2text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/FF/mdsdim1dim3.pdf",width = 10,height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/FF/mdsdim1dim3text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/FF/mdsdim1dim4text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/FF/mdsdim2dim3text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
...
pdf("./plots/FF/mdsdim3dim4text.pdf",width = 10, height = 10)
#plot(dim1nm,dim2nm,type="n")
#text(dim1nm, dim2nm, labels = row.names(data), cex=.7)
print(
